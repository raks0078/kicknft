  ...
  constructor(props) {
    ...
    this.state = {
      ...
      data: [
        ...
        { id: 6, label: "Twitter", icon: <TwitterIcon /> },
        { id: 7, label: "teligram", icon: <TwitterIcon /> },
        { id: 8, label: "instagram", icon: <TwitterIcon /> },
        { id: 9, label: "discord", icon: <TwitterIcon /> },
        { id: 10, label: "youtube", icon: <TwitterIcon /> },
        { id: 11, label: "medium", icon: <TwitterIcon /> },
      ],
      comunityVal: "",
    }
  }
